            ...
            <div class="clearfix logo-nav-box pd-left-right-50px">
                <div class="container-fluid">
                    <div class="logo-nav-box-container">
                        <!-- Logo -->
                        <a href="#" class="logo d-flex align-items-center k-hover">
                        ...
                        <div class="col-12 col-xl-7 col-lg-8 col-lg-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <!-- Register Form -->
                                    <form action="<?= ROOT_URL ?>index-logic.php" class="form-sign contact-form needs-validation p-3" enctype="multipart/form-data" method="POST" novalidate>
                                        <h1 class="h2" style="color: #24262b;">Accès au site : inscription</h1>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtFirstName3" class="form-label">Nom<span class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control form-control-lg" id="txtFirstName3" name="nom" placeholder="Nom" value="<?= $nom ?>">

                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="txtLastName3" class="form-label">Prénom<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control form-control-lg" id="txtLastName3" name="prenom" placeholder="Prénom" value="<?= $prenom ?>">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="statut" id="txtListStatus" class="form-control form-control-lg">
